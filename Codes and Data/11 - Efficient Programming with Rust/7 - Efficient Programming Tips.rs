   // -------------------------------------------
   // 			Nested Condition using Match
   // 			Pulling up the first error 
   // 			Using hashmaps to effectively access objects of structs 
   // 			Reverse ranges 
   // -------------------------------------------
...
// Example 2: Pulling up the first error in the list or all the ok variants
/*
fn main() {
...
// Example 3: using hashmaps to effectively access objects of structs 
/*
...
// Example: 4: In Rust, we can write for item in 0..50 to go from 0 to 49 but what if we wanted to iterate from 49 to 0? Many of us have written for item in 50..0 and been surprised that nothing happened. Instead, we can write:
/*
fn main() {
